...
public class LastCombatActivity extends AppCompatActivity {
    ...
    public static Account userAccountComlast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAccountComlast = LastActivity.userAccountLast;
        ...
        // Game elements
        currScenario = new CombatScenario(userAccountComlast.getUsername(), 2);  //change this
        gameOver = false;
